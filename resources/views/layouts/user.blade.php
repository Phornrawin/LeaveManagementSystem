    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
            <div class="list-group">
                ...
                <a class="list-group-item list-group-item-action" data-toggle="collapse" data-target="#collapseLeave" aria-expanded="true" aria-controls="collapseLeave">My Leaves  <i class="fas fa-caret-down"></i><span class="badge badge-pill badge-success float-right"> 1 </span></a>
