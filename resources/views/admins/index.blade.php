...
<div class="row">
  ...
  <div class="col-9" style="margin: 10px">
    ...
    <div class="main-content">
        ...
        <p class="explanation">This is web service for organization who want to use system for manage leave system</p><p>in organization. This site is divided into two parts. The first is the part for admin to manage </p> <p>service system. Admin can create user for members of organization, can create department of organization and</p><p> can modify leave rules for use in the system. The second is the part for user to use system. </p><p>User can make leave request to leader. Moreover, user can assign tasks to own subordinates.</p>
        <br>
        ...
        <p class="explanation">Admin can create department for use in organization by click <span class="method">"Department" >> "Create department"</span></p> <p>button in left menu. Then admin must fill organizational department's information in the box and click "Submit" button.</p>
        ...
        <p class="explanation">Admin can delete department by click <span class="method">"Department" >> "Delete department"</span></p><p> button in left menu. Then choose department that want to delete.</p>


        <h4 id="User-Management" class="minor-topic jumptarget">User management</h4>
        <h5 class="sub-minor-topic">Create user</h5>
        <p class="explanation">Admin can create user for members in organization by click <span class="method">"User" >> "Create User"</span></p><p> button in left menu. Then admin must fill user's infomation in the box and click "Submit" button.</p>
        ...
        <p class="explanation">Admin can modify your organization's leave rule by click <span class="method">"Leave"</span></p><p> button in left menu. Then admin must choose rule for organization and click "Submit" button.</p>
        <br>
        ...
        <p class="explanation">User can make leaves request by click <span class="method">"My Leaves" >> "Make new leave request"</span></p><p> button in left menu. Then fill leave information in the box and submit.</p>
        <h5 class="sub-minor-topic">Show all requests to user</h5>
        <p class="explanation">User can see all requests that have two type. Request for leaves and Request for substituting. User can see Request for leaves by click </p> <p><span class="method">"Requests to me" >> "Request for leaves"</span> button in left menu and can see Request for substituting by click <span class="method"></p><p>"Requests to me" >> "Request for substituting"</span> button in left menu. Moreover, user can approve that request.</p>
        ...
        <p class="explanation">User can assign task to user's subordinates by click <span class="method">"My subordinates" >> "Assign tasks"</span></p><p> button in left menu. Then fill assignment infomation in the box and click "ASSIGN" button.</p>
